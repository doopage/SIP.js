...
export class Inviter extends Session {
    ...
    onAccept(inviteResponse) {
        ...
        if ((_a = this.delegate) === null || _a === void 0 ? void 0 : _a.onAccept) {
            this.delegate.onAccept(inviteResponse);
        }
    ...
    onProgress(inviteResponse) {
        ...
        if ((_a = this.delegate) === null || _a === void 0 ? void 0 : _a.onProgress) {
            this.delegate.onProgress(inviteResponse);
        }
        const response = inviteResponse.message;
        const session = inviteResponse.session;
        ...
        switch (session.signalingState) {
            ...
            case SignalingState.HaveRemoteOffer:
                ...
                }
                {
                    ...
                    if ((_b = this.delegate) === null || _b === void 0 ? void 0 : _b.onSessionDescriptionHandler) {
    ...
    onRedirect(inviteResponse) {
        ...
        if ((_a = this.delegate) === null || _a === void 0 ? void 0 : _a.onRedirect) {
            this.delegate.onRedirect(inviteResponse);
        }
        // transition state
        this.stateTransition(SessionState.Terminated);
    }
    ...
    onReject(inviteResponse) {
        ...
        if ((_a = this.delegate) === null || _a === void 0 ? void 0 : _a.onReject) {
            this.delegate.onReject(inviteResponse);
        }
        // transition state
        this.stateTransition(SessionState.Terminated);
    }
